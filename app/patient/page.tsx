...
type Screen = "welcome" | "language" | "session" | "chat"
          ...
          <div className="p-6 h-64 overflow-y-auto space-y-4">
            {messages.map((msg) => (
              <div key={msg.id} className={`flex ${msg.sender === "doctor" ? "justify-start" : "justify-end"}`}>
                <div
                  className={`max-w-xs lg:max-w-md p-4 rounded-2xl text-lg ${
                    msg.sender === "doctor"
          ...
          {showKeyboard ? (
            ...
            <div className="flex gap-6 justify-center">
              ...
              <Button
                ...
                className={`w-32 h-32 rounded-full text-white shadow-2xl transform hover:scale-105 transition-all duration-200 ${
              ...
              <Button
                ...
                className="w-32 h-32 rounded-full bg-teal-600 hover:bg-teal-700 text-white shadow-2xl transform hover:scale-105 transition-all duration-200"
              >
                <div className="text-center">
          ...
          <div className="space-y-8">
            ...
            <div className="py-8">
              <Button
                ...
                className="text-3xl px-16 py-8 bg-blue-600 hover:bg-blue-700 rounded-2xl shadow-lg transform hover:scale-105 transition-all duration-200"
              >
                Tap to Start
              </Button>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
              {languages.map((language) => (
                <Button
                  ...
                  className="h-24 text-2xl font-semibold bg-white hover:bg-teal-50 text-teal-800 border-2 border-teal-200 hover:border-teal-400 rounded-xl shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-200"
                  variant="outline"
                >
                  <div className="text-center">
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-purple-100 flex items-center justify-center p-8">
        <Card className="w-full max-w-2xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-purple-800 mb-4">Join Session</h1>
            <p className="text-xl text-gray-600">Enter the session ID provided by your doctor</p>
          </div>
